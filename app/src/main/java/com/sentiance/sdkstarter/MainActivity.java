...
import static com.sentiance.sdkstarter.MyApplication.ACTION_SENTIANCE_STATUS_UPDATE;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume () {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(statusUpdateReceiver, new IntentFilter(ACTION_SENTIANCE_STATUS_UPDATE));
